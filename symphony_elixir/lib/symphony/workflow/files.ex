defmodule Symphony.Workflow.Files do
  ...
  @templates %{
    "blank" => %{
      id: "blank",
      name: "MISCONDUCT Default Score",
      description:
        "Ready-to-edit MISCONDUCT defaults for manual Conductor intake, Direct Codex, Judge, and Refiner.",
      tags: ["misconduct", "default", "codex"],
      required_context: [],
  ...
  defp template("blank", o) do
    name = value(o, "name", "misconduct-default")

    objective =
      value(
        o,
        "objective",
        "Coordinate operator-supplied MISCONDUCT movements through Direct Codex builder, judge, and refiner stages."
      )
    ...
    schema_version: 1
    name: #{yaml(name)}
    description: MISCONDUCT default workflow for Direct Codex orchestration.
    tracker:
      kind: none
    ...
    - Workspace: ./misconduct_workspaces
    - Workflow version: 1
    ...
    ## Artifacts
    - Workspace changes in ./misconduct_workspaces/{{ issue.identifier }}
    ...
    - Runtime reload is supported from MISCONDUCT when no active runs are in flight.
    ...
    ## Change Log
    - Initial MISCONDUCT default workflow generated by MISCONDUCT.
    """
    |> String.trim()
    |> Kernel.<>("\n")
  end
  ...
  defp template("linear_codex_judge_refiner", o) do
    ...
    ## Change Log
    - Initial Linear/Codex judge-refiner workflow generated by MISCONDUCT.
    """
    |> String.trim()
    |> Kernel.<>("\n")
  end
  ...
  defp template("repository_orchestra", o) do
    ...
    ## Agents
    - Use configured MISCONDUCT agent profiles only.
    ...
    ## Change Log
    - Initial repository orchestra workflow generated by MISCONDUCT.
    """
    |> String.trim()
    |> Kernel.<>("\n")
  end
